...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    products: Attribute.Relation<
      ...
      'api::product.product'
    >;
    catagoryImg: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ratings_num: Attribute.Decimal;
    num_reviews: Attribute.Integer;
    colors: Attribute.JSON;
    all_colors: Attribute.JSON;
    description: Attribute.RichText;
    stocks: Attribute.Integer;
    feature: Attribute.String;
    techology: Attribute.String;
